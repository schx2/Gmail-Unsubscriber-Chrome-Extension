...
chrome.tabs.onCreated.addListener(function(tab){
  //add logic to filter emails

  chrome.tabs.query({url:"http://you-should-be-unsubscribed-and-not-see-this-page.com/*"},function(t){
    if (t[0]){
  ...
  function sendEmail(mail) {
    return result = new Promise(function(resolve, reject) {
      ...
      if (typeof access_token !== 'undefined'){
        ...
        var string = "To: " + email + "\r\nSubject: Unsubscribe\r\n\r\nThis message was automatically generated by the Gmail Unsubscriber Chrome extension after you clicked on an 'Unsubscribe' button."
